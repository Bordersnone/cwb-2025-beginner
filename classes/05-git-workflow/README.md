...
[→ Render Deployment Check Guide](../07-deploy-to-www/render-deployment-check.md)
...
[→ HTML About Page Guide](../01-most-common-tags/steps/html-about-page.md)
...
[→ Mini-Challenge Guide](../01-most-common-tags/steps/mini-challenge.md)
...
← [Class 4 - Media and Links](../04-html-paths/) | [Class 7 - Deploy Your First Page](../07-deploy-to-www/) →